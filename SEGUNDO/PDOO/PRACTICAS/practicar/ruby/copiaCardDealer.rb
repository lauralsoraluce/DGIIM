...
=end
    ...
    def createEnemies() 
        ...
        myDamage = SpecificDamage.new([WeaponType::LASER, WeaponType::LASER, WeaponType::LASER, WeaponType::LASER, WeaponType::LASER, WeaponType::MISSILE, WeaponType::MISSILE, WeaponType::MISSILE, WeaponType::MISSILE, WeaponType::MISSILE, WeaponType::PLASMA, WeaponType::PLASMA, WeaponType::PLASMA, WeaponType::PLASMA, WeaponType::PLASMA],0)
=begin
...
=end
	@enemies.add(EnemyStarShip.new("Enemigo easy", 500, 500, badLoot, myDamage))
    end
end # class
