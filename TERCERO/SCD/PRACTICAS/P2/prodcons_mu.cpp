...
int producir_dato( int num_hebra )
{
   ...
   const int valor_producido = num_hebra*cada_prod+producidos[num_hebra] ;
...
void funcion_hebra_productora( MRef<ProdConsSU1> monitor , int num_hebra)
{
...
void funcion_hebra_consumidora( MRef<ProdConsSU1>  monitor, int num_hebra)
{
   for( unsigned i = 0 ; i < cada_cons ; i++ )
   {
...
int main()
{
   ...
   thread hebras_prod[num_productoras];
   thread hebras_cons[num_consumidoras];
