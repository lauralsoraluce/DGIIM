...
LataPeones::LataPeones() {
    ...
    Material* materialPeonMadera = new Material(texturaXY_madera, 0.5, 0.6, 0.5, 50.0); //pseudo especular o metálico
    Material* materialPeonBlanco = new Material(0.5, 0.2, 0.5, 5.0); // difuso o mate
    Material* materialPeonNegro = new Material(0.01, 0.2, 0.5, 50.0); // combinación de ambos
