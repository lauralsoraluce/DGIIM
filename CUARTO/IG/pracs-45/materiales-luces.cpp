                    ...
                    const float p_k_pse, const float p_exp_pse )
{
   ...
   k_amb    = p_k_amb ; // reflexión ambiental, cómo de iluminado está
   k_dif    = p_k_dif ; // reflexión difusa
   k_pse    = p_k_pse ; // reflexión especular
   exp_pse  = p_exp_pse ; assert( 0.5 <= exp_pse ); // exponente de brillo 
}
//----------------------------------------------------------------------
