...
void Escena::visualizarGL( )
{
   ...
   if (apl->modo_visu== ModosVisu::puntos){
      ...
      cout << "Error en el modo de visualizacion" << endl;
   }
...
Escena1::Escena1()
{
   ...
   //objetos.push_back(new Circulo(40));
...
Escena2::Escena2()
{
   ...
   objetos.push_back(new MallaRevolPLY("peon.ply", 30));
   objetos.push_back(new Cilindro(8, 40));
   objetos.push_back(new Cono(16, 32));
   objetos.push_back(new Esfera(24, 48));
   objetos.push_back(new PiramideEstrellaZ(8));
   objetos.push_back(new RejillaY(5, 10));
...
Escena3::Escena3()
{
   ...
   //objetos.push_back(new P3Cubo());
   //objetos.push_back(new P3Abatible(random));
   //objetos.push_back(new P3Caja());
   //objetos.push_back(new P3Cuadrado());
   objetos.push_back(new Cuco());
