...
(:goal 
    (and
        ...
        ;indirectamente vamos a tener que poseer estas dos investigaciones para construir teletransportadores y soldados
        ( invTerminada InvSold1 )
        ( invTerminada InvTele1 )
        ;número de pasos del programa5, para un valor menor de este no me termina
        (< (costePlan) 53)
    )
)
